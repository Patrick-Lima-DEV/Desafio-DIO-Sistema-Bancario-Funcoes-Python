...
## Estrutura do Código
- `sistema_bancario.py`: concentra as funções `depositar`, `sacar` e `exibir_extrato`, além do loop principal que interpreta o menu e controla o ciclo de vida da aplicação.
